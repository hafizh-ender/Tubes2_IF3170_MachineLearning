...
class LabelEncoderIOTransformerStrategy(IOTransformerStrategy):
    def __init__(self, strategy: TransformerStrategy):
        super().__init__(strategy)

    def fit(self, pl_property: PipelineProperty):
        self._strategy.fit(pl_property.X_transformed)

    def transform(self, pl_property: PipelineProperty):
        pl_property.X_transformed = self._strategy.transform(pl_property.X_transformed)
